...
const content = {
    ...
    sv: {
        ...
        homePrintingDescription: "<strong>3D Printing</strong> är en teknik som skapar tredimensionella objekt genom att bygga upp lager av material baserat på en digital modell. Detta möjliggör snabb och anpassad tillverkning inom olika branscher, inklusive medicin, fordon och design.",
        homeScanningDescription: "<strong>3D Scanning</strong> används för att digitalisera fysiska objekt genom att skapa en korrekt digital representation. Den används ofta i reverse engineering, medicinsk forskning, konstkonservering och industriella tillämpningar.",
        homeHowTitle: "Hur fungerar tekniken?",
        fdmDesc: "Smälter och extruderar plastfilament lager för lager.",
        fdmCaption: "<strong>Exempel på FDM skrivare sedan vanlig PLA FDM Plastfilament till en färdig produkt. På den här bilden ett lokomotiv</strong>",
        ...
        // INFORMATION Page
        infoTitle: "Arbetsflöde för \"3D Scannat objekt till 3D Printbar fil\"",
        infoWorkflow: "När ett objekt har scannats får du en nätfil, ett skal av den scannade ytan som består av referenspunkter som bildar trianglar. Filen importeras till programmet, t.ex. Fusion 360, där du behöver granska eventuella missade data som kan generera hål i nätet, eller direkta fel i den avbildade scanningen. Det kan även komma med oönskad scannat material från omgivningen som behöver rensas undan. När filen väl är lagad och meshen är rensad och hel sparas den bara som en .stl-fil och importeras i slicerprogrammet. I slicerprogrammet väljer du de inställningar du vill ha och sparar som en .gcode-fil. Den filen innehåller inställningar för skrivaren, såsom temperatur, hastighet, matning och koordinater i X-Y-Z-riktningar som skrivaren sedan följer.",

        infoScannerDiffTitle: "Skillnader mellan iPad, Artec och ATOS scannrar",
        infoIpad: "Vi testade scanning med iPad, Artec Eva och Atos scanner, och funktionellt fungerar scanningen på liknande sätt. Man fotograferar objektet från de sidor man vill ha med. Med en <strong>iPad eller iPhone/Android</strong> telefon kan man nu scanna objekt, och få ett resultat som lämpar sig för enklare modellering, såsom mindre noggrannhet, skulpturer eller saker med mindre noggrannhet, <em>a saker. använd:</em> Mest lämplig för enklare bilder för t.ex. hemanvändare eller där objektet är mindre detaljerat.",
        infoCaptionIpad: "<strong>Skanna med iPhone och </strong><em>Qlone</em>-appen",
        infoArtec: "<strong>Artec Eva</strong> är en handhållen scanner som ger mycket bra resultat med en noggrannhet på upp till 0,1 mm, och är lämplig för medelstora till stora objekt. Du scannar objektet genom att flytta scannern över eller runt det tills alla ytor är scannade. Scannern tar bilder kontinuerligt och du måste försöka scanna snabbt men samtidigt få all vinkel att öva in, eftersom scannern är konstant. bilder kan filerna bli väldigt tunga om du är för långsam <em>Användningsområde:</em> Professionell användning: virtuella 3D-modeller, konst, design, sjukvård och omvänd konstruktion.",
        infoAtos: "<strong>Atos</strong>-scannern skiljer sig från tidigare scannrar genom att scannern är monterad och du snurrar objektet och tar en stillbild/scannar och sedan roterar objektet och tar en ny bild och upprepar tills du täcker alla vinklar. Den kan även monteras på en robot. Den har hög noggrannhet, upp till 0,02 mm. <em>Area, mått, analys och omvänd användning:</em> kontroller.",
        infoCaptionArtec: "<strong>Scanning med Artec och Atos scannrar</strong>",
        infoComparisonTitle: "Jämförelse av skannat objekt (stl) med CAD-fil (stl eller stp)",
        infoComparison: "En scannad fil innehåller mätpunkter från det scannade objektet, dessa bildar trianglar som ett nät (nät). Den har ingen faktisk yta eller volym, bara koordinatreferenser. Detaljnivån beror på punktdensitet och triangelstorlek. En CAD-fil bildar en solid modell och har full volym och referenser, vilket möjliggör fullständig dataextraktion.",
        ...
        infoGom: "I ett mätprogram, såsom GOM Inspect, kan du importera både den scannade geometrin och den ursprungliga CAD-filen. Du kan kombinera både geometrier och mäta avvikelser och eventuella defekter i den tillverkade delen. Detta hjälper till att säkerställa precision i produktion och kvalitetskontroll.",
        infoCaptionGom: "<strong>Exempel på mätdata i GOM Inspect</strong>",
        infoIndustriesTitle: "Branscher som använder 3D Scanning",
        infoIndustriesIntro: "Några exempel på branscher där 3D Scanning används idag är:",
        ...
        industryConstruction: "Scanna byggnader, ytor, även terräng och landskap.",
